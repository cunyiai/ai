...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupClickListeners() {
        ...
        btnCamera.setOnClickListener { onCameraClicked() }
    ...
    private fun enableInput(enable: Boolean) {
        ...
        if (!enable) {
            ...
            btnImage.isEnabled = engine.isVisionSupported
            btnCamera.isEnabled = engine.isVisionSupported
        }
    }
    ...
    private fun launchCamera() {
        val cacheDir = File(cacheDir, "camera_photos").apply { mkdirs() }
        cameraPhotoFile = File(cacheDir, "photo_${System.currentTimeMillis()}.jpg")
        val photoUri = FileProvider.getUriForFile(
            this,
            "${packageName}.fileprovider",
            cameraPhotoFile!!
        )
        takeCameraPicture.launch(photoUri)
    }
    // ==================== End Camera feature ====================
